...
module.exports = function(app){
  ...
  app.post('/vacations', vacation.vacationsProcessPost);
  ...
  app.get('/cart', cart.middleware,
                   cartValidation.checkWaivers,
                   cartValidation.checkGuestCounts,
                   cart.home);
  ...
  app.get('/headers', samples.headersTest);
